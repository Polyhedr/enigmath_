...
\begin{center}
    \includegraphics[width=0.4\textwidth]{enigmes/Le défi des trois dés/image.png}
\end{center}
\subsection*{Énoncé}
...
\begin{lstlisting}
(*@\textcolor{black!60}{\scriptsize python}\hfill\href{https://enigmath.vercel.app/enigmas/Le%20d%C3%A9fi%20des%20trois%20d%C3%A9s/1.py}{\emoji{down-arrow}~\textcolor{black!60}{Télécharger le code~}}@*) 
(*@ @*)\end{lstlisting}\vspace{-.455cm}\lstinputlisting{enigmes/Le défi des trois dés/1.py}
...
\begin{lstlisting}
(*@\textcolor{black!60}{\scriptsize python}\hfill\href{https://enigmath.vercel.app/enigmas/Le%20d%C3%A9fi%20des%20trois%20d%C3%A9s/4.py}{\emoji{down-arrow}~\textcolor{black!60}{Télécharger le code~}}@*) 
(*@ @*)\end{lstlisting}\vspace{-.455cm}\lstinputlisting{enigmes/Le défi des trois dés/4.py}
