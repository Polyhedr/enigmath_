...
\begin{center}
    \includegraphics[width=0.4\textwidth]{enigmes/Manger un max de pizza/image.jpg}
\end{center}
\subsection*{Énoncé}
...
\textbf{Questions} :
\begin{enumerate}
    \item Montrez qu'Alice peut manger au moins la moitié de la pizza avec un nombre pair de parts.
    \item \emoji{hot-pepper} Montrez qu’Alice peut manger au moins le tiers de la pizza en suivant une stratégie où, après avoir choisi sa première part, elle prend systématiquement la part révélée par Bob.
    \item Montrez que c’est le mieux qu’Alice puisse faire si, après avoir choisi sa première part, elle prend systématiquement la part révélée par Bob.
    \item \emoji{laptop} Montrez que Bob peut choisir une découpe de la pizza de manière à s'assurer de manger au moins $\frac{5}{9}$ de celle-ci.
    \item \emoji{hot-pepper}\emoji{hot-pepper}\emoji{hot-pepper} Montrez qu’Alice peut manger au moins $\frac{4}{9}$ de la pizza.
...
\begin{lstlisting}
(*@\textcolor{black!60}{\scriptsize python}\hfill\href{https://enigmath.vercel.app/enigmas/Manger un max de pizza/4.py}{\emoji{down-arrow}~\textcolor{black!60}{Télécharger le code~}}@*) 
(*@ @*)\end{lstlisting}\vspace{-.455cm}\lstinputlisting{enigmes/Manger un max de pizza/4.py}
...
% vggt study !
% amodal MOTS : stage
% segmentation pour einstein : Patent
% WALT4D : Patent
%
% todo
% reimprimer octant
% aller chercher doctorat en allant voir Vianney
% ASCS
