...
\begin{center}
    \includegraphics[width=0.4\textwidth]{enigmes/Recruter un stagiaire/image.jpg}
\end{center}
\subsection*{Énoncé}
...
\textbf{Questions} :
\begin{enumerate}
    \item \emoji{hot-pepper}\emoji{laptop} Peut-on concevoir une stratégie qui garantisse à l’entreprise de recruter, avec une probabilité d’au moins $1/e$, l’étudiant avec le meilleur score parmi les $n$ ?

    \item  
L’entreprise a consulté les archives des années précédentes et connaît désormais la distribution des scores des étudiants dans l’université. 
...
\item \emoji{hot-pepper} 
Supposons que l’entreprise ait désormais la possibilité de réorganiser librement l’ordre des entretiens dans la liste de passage avant qu’ils ne commencent. En appliquant ensuite la stratégie optimale, quel ordre doit-elle choisir pour maximiser le score moyen de l’étudiant recruté ?
