...
\textbf{Questions} :
\begin{enumerate}
    \item En supposant que les habitants se déplacent uniquement le long des rues du quadrillage, 
déterminez, pour une Grande Allée donnée, le temps de trajet d'un habitant jusqu'à celle-ci. 
    
    \item \emoji{hot-pepper} Proposez un algorithme en temps  quasi-quadratique en $n$, 
...
\item \emoji{hot-pepper} Avant le début de la construction, plusieurs villages voisins (organisés eux aussi en quadrillage) souhaitent 
