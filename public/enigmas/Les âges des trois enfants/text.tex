...
\textbf{Questions} :
\begin{enumerate}
    \item Quels âge ont les enfants de Monsieur A ? 
    
    \item \emoji{laptop} Existe-t-il une autre valeur du produit $N$, différente de $36$, conduisant à la même énigme ? 
...
sont les triplets mystérieux.
    \item Montrez que les triplets mystérieux d'un NTC ne peuvent pas avoir d’élément en commun.
    \item Montrez qu’un NTC n’est jamais une puissance d’un nombre premier.
    \item Montrer que tout NTC s’écrit comme un produit d’au moins quatre nombres premiers (pas nécessairement distincts).
    \item Soit $p$ un nombre premier tel que $2p - 1$ soit également premier.  
Montrer que
\(
N = p^2 (2p - 1)^2
\)
