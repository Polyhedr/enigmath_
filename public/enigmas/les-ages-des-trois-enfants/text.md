...
3. 🌶️${}^{\color{red}1.4}$ Montrez que les triplets mystérieux d'un NTC ne peuvent pas avoir d’élément en commun.

4. 🌶️${}^{\color{red}1.5}$ Montrez qu’un NTC n’est jamais une puissance d’un nombre premier.

5. 🌶️${}^{\color{red}1.6}$ Montrer que tout NTC s’écrit comme un produit d’au moins quatre nombres premiers (pas nécessairement distincts).

6. 🌶️${}^{\color{red}1.9}$ Soit $p$ un nombre premier tel que $2p - 1$ soit également premier.  
Montrer que
$
N = p^2 (2p - 1)^2
$
