...
1. 🌶️${}^{\color{red}1.6}$💻${}^{\color{blue}0.9}$ Peut-on concevoir une stratégie qui garantisse à l’entreprise de recruter, avec une probabilité d’au moins $1/e,$ l’étudiant avec le meilleur score parmi les $n$&nbsp;?

2. 🌶️${}^{\color{red}1.0}$ L’entreprise a consulté les archives des années précédentes et connaît désormais la distribution des scores des étudiants dans l’université. 
