\section*{L'énigme de Freudenthal} % en chantier
\begin{center}
...
\textbf{Questions} :
\begin{enumerate}
    \item \emoji{laptop} Quels sont ces deux nombres ?
    \item \emoji{hot-pepper}\emoji{laptop} Quel est le plus grand entier, tel que si l'on remplace dans l'enoncé précédent 100 par cet entier, il soit toujours possible de trouver les deux inconnues, après avoir assisté à la conversation ci-dessus ?
\end{enumerate}
