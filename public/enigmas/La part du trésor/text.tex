...
\end{center}
\subsection*{Énoncé}
Une horde de 12 pirates doivent se partager un trésor de 100 pièces d'or qu'ils viennent de dérober sur un navire. Ils décident de procéder comme ceci :
...
\textbf{Questions} :
\begin{enumerate}
\item Quel partage va proposer le plus vieux sachant que les pirates sont cupides, sadiques (même s'il n'ont rien à gagner de plus, il choisiront de vous exécuter) mais qu'en priorité ils souhaitent garder la vie sauve ?
\item Pour 208 pirates, l'aîné est-il sûr d'être exécuté quel que soit le partage qu'il propose ?
\item Avec $N$ pirates et $G$ pièces d'or, tels que $N > 2G$, déterminez :
    \begin{itemize}
