\section{La prison circulaire de taille inconnue} % en chantier
\begin{center}
    \includegraphics[width=0.4\textwidth]{enigmes/La prison circulaire de taille inconnue/image.png}
\end{center}
\subsection*{Énoncé}
...
\textbf{Questions} :
\begin{enumerate}
    \item \emoji{hot-pepper} On admet que les prisonniers peuvent lancer des pièces, ce qui leur permet de prendre des décisions aléatoires que le gardien ne peut pas prévoir, même s’il connaît leur stratégie. Décrivez une stratégie permettant aux prisonniers de déterminer $n$ (presque sûrement).
    \item \emoji{hot-pepper} Donnez une solution qui n’utilise aucune forme d’aléatoire et qui garantit d’aboutir en un nombre déterminé de jours.
    \item On suppose que la prison n’est plus circulaire, mais forme un graphe orienté fortement connexe, chaque cellule contenant au moins un interrupteur et une lumière, et chaque lumière étant contrôlée par exactement un interrupteur situé dans une autre cellule. Décrivez une stratégie permettant aux prisonniers de déterminer $n$.
\end{enumerate}
...
\begin{lstlisting}
(*@\textcolor{black!60}{\scriptsize python}\hfill\href{https://enigmath.vercel.app/enigmas/La prison circulaire de taille inconnue/1.py}{\emoji{down-arrow}~\textcolor{black!60}{Télécharger le code~}}@*) 
(*@ @*)\end{lstlisting}\vspace{-.455cm}\lstinputlisting{enigmes/La prison circulaire de taille inconnue/1.py}
...
\begin{lstlisting}
(*@\textcolor{black!60}{\scriptsize python}\hfill\href{https://enigmath.vercel.app/enigmas/La prison circulaire de taille inconnue/2.py}{\emoji{down-arrow}~\textcolor{black!60}{Télécharger le code~}}@*) 
(*@ @*)\end{lstlisting}\vspace{-.455cm}\lstinputlisting{enigmes/La prison circulaire de taille inconnue/2.py}
