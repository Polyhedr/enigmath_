...
Revenez dans le dossier racine parent et modifiez `main.tex`, en mettant à jour la ligne :
...
Utilisez **overleaf** (avec lualatex) ou lancez ensuite les commandes suivantes dans votre terminal :
...
Cela générera votre `main.pdf`. 

Zippez le dossier de votre énigme et envoyez-le par mail à **contact.enigmath@proton.me**.